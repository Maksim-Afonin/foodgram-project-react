# Generated by Django 4.0.2 on 2023-01-16 18:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Время должно быть не меньше 1 минуты')], verbose_name='Время приготовления(мин.)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True, verbose_name='Адрес(url)')),
            ],
            options={
                'verbose_name': 'Тег',
